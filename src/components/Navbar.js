...
import {DollarSign, Home, Moon, Sun} from 'react-feather';
      ...
      >
        ...
        {windowSize.width >= 769 && (
          <>
            ...
            <a
              href="https://milaap.org/fundraisers/support-covid19kashmir-1/"
              target="_blank"
              rel="noreferrer"
            >
              <span>
                <DollarSign {...activeNavIcon('/blog')} />
              </span>
            </a>
            <span>
              <SunMoon {...{darkMode}} />
  ...
  return (
    <div className="expand" ref={expandElement} onMouseLeave={handleMouseLeave}>
      ...
      <div className="expand-bottom">
        <h5>{t('A Non Profit initiative.')}</h5>
      </div>
    </div>
  );
}
